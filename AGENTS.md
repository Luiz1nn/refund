...
- `src/App.tsx` is currently blank and is the starting point for app routes or layout.
- `src/styles.css` imports Tailwind CSS and holds global styles.
- `src/assets/` is reserved for local images, icons, and static source assets.
